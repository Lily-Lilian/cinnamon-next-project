...
function Footer() {
  return (
    <div className='bg-black bg-opacity-90 footer pt-20 pb-10 '>
        <div className="content text-white flex flex-col gap-8 max-w-6xl mx-auto">
            <div className="grid lg:grid-cols-11">
                <div className="lg:col-start-1 lg:col-end-5">
                    <img src="/assets/logo-white.svg" alt="" className='w-40 mb-[44px]' />
                </div>
